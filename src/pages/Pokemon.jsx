  ...
  return (
    <main className='Pokemon'>
      <section className='pokemonId'>
        ...
        <img src={dataPokemon?.sprites.other['official-artwork'].front_default} alt={dataPokemon?.name} className="pokemonId__img" />
        ...
        <section className='pokemonId__info'>
          <div className='pokemonId__info-container'>
            <h4 className='pokemonId__info-title'>Type</h4>
